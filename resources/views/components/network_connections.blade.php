...
<div class="row justify-content-center mt-5">
  <div class="col-12">
    ...
    <label class="btn btn-outline-primary" for="btnradio1" id="get_suggestions_btn">
        ...
        Suggestions ({{$attributes['sugestion_count']}})</label>



          <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
          <label class="btn btn-outline-primary" for="btnradio2" id="get_sent_requests_btn">Sent Requests ({{$attributes['send_request_count']}})</label>

          <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
          <label class="btn btn-outline-primary" for="btnradio3" id="get_received_requests_btn">Received
            Requests({{$attributes['recieve_count']}})</label>

          <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
          <label class="btn btn-outline-primary" for="btnradio4" id="get_connections_btn">Connections ({{$attributes['connection_count']}})</label>
        </div>
        <hr>
        ...
        <x-request :mode="'sent'" :suggestions="'$suggestions'"/>
